...
int main(int argc, char* argv[]){
	...
	optarc_t best = monte_carlo(num_input_nodes, num_output_nodes, max_hidden_nodes, max_hidden_layers, num_folds, learning_rate, scaling_factor, duration, data_list);
